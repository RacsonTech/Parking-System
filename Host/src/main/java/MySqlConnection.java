...
public class MySqlConnection
{
  ...
  public MySqlConnection() throws SQLException {
    ...
    System.out.println("Establishing a connection to MySQL.");
  ...
  private void readMySqlCredentials() {
    ...
    try {
      ...
      mySqlUrl = properties.getProperty("MYSQL_DB_URL");
      mySqlUser = properties.getProperty("MYSQL_DB_USERNAME");
      mySqlPassword = properties.getProperty("MYSQL_DB_PASSWORD");
