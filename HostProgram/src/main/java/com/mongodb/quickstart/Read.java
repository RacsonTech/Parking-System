...
public class Read {
    ...
    public static void main(String[] args) {
        try (MongoClient mongoClient = MongoClients.create(System.getProperty("mongodb.uri"))) {
            ...
            System.out.println("Student list with greater than or equal to 10000, with a cursor: ");
            ...
            System.out.println("Student list with an ArrayList (Lists are easier to manipulate than iterators):");
            ...
            System.out.println("Student sorted, skipped, limited and projected (Good for pagination): ");
